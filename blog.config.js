...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，这是羽设服装作品集🎉',
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/yu.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/2.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
